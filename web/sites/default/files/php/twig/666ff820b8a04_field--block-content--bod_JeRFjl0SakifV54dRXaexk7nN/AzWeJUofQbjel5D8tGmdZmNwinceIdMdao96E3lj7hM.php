...
/* themes/custom/dark/templates/field/field--block-content--body--contact-button.html.twig */
class __TwigTemplate_826ea80f80c44bfdc468d6faff88557c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/dark/templates/field/field--block-content--body--contact-button.html.twig";
    }
...
{% if label_hidden %}
    {% for item in items %}
      <a href=\"#contacts\"><div{{ attributes }}>{{ item.content }}</div></a>
    {% endfor %}
{% endif %}", "themes/custom/dark/templates/field/field--block-content--body--contact-button.html.twig", "/var/www/project/my-project/web/themes/custom/dark/templates/field/field--block-content--body--contact-button.html.twig");
    }
